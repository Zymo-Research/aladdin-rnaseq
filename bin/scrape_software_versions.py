...
regexes['BAMscale'] = ['v_BAMscale.txt', r"Version: v(\S+)"]
regexes['featureCounts'] = ['v_featurecounts.txt', r"featureCounts v(\S+)"]
regexes['Salmon'] = ['v_Salmon.txt', r"salmon (\S+)"]
regexes['DESeq2'] = ['v_DESeq2.txt', r"(\S+)"]
regexes['gProfiler'] = ['v_gProfiler.txt', r"gprofiler-official==(\S+)"]
regexes['DEXSeq'] = ['v_DEXSeq.txt', r"(\S+)"]
regexes['DRIMSeq'] = ['v_DRIMSeq.txt', r"(\S+)"]
regexes['stageR'] = ['v_stageR.txt', r"(\S+)"]
